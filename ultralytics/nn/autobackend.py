...
class AutoBackend(nn.Module):
    ...
    def __init__(
            ...
            if onnx:
                ...
                check_requirements(
                    [
                        ...
                        "sony-custom-layers[torch]==0.2.0",
        ...
        # NVIDIA Triton Inference Server
            ...
            from ultralytics.utils.triton_async import AsyncTritonRemoteModel

            model = AsyncTritonRemoteModel(w)
    ...
    async def async_call(self, im, augment=False, visualize=False, embed=None):
        """
        Runs inference on the YOLOv8 MultiBackend model.
        ...
        # NVIDIA Triton Inference Server
            ...
            im = im.cpu().numpy()  # torch to numpy
            y = await self.model.async_call(im)
